...
IF OBJECT_ID('DEMO.uspFixOrphanSalesOrderRows', 'P') IS NOT NULL
BEGIN
	DROP PROCEDURE DEMO.uspFixOrphanSalesOrderRows 
END
GO
CREATE PROCEDURE DEMO.uspFixOrphanSalesOrderRows @DiagMode BIT = 1 AS
IF @DiagMode = 1
BEGIN
	--1. SORDERP where missing SORDER
	SELECT * 
